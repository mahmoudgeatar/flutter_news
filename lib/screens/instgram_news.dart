...
class InstagramNews extends StatefulWidget {
  @override
  _InstagramNewsState createState() => _InstagramNewsState();
}

class _InstagramNewsState extends State<InstagramNews> {
